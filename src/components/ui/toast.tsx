...
>(({ className, variant = 'default', ...props }, ref) => (
  <ToastPrimitive.Root
    ref={ref}
    className={cn(
      'flex items-start gap-3 rounded-lg border p-4 shadow-lg data-[state=open]:animate-fade-in bg-surface-raised',
      variant === 'error' ? 'border-danger/30 text-danger' : 'border-border text-text-primary',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Close
    ref={ref}
    className={cn('ml-auto text-text-muted hover:text-text-primary', className)}
    {...props}
  >
    <X className="h-4 w-4" />
  </ToastPrimitive.Close>
